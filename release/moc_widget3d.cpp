...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_widget3d_t, stringdata) + ofs \
...
const QMetaObject widget3d::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_widget3d.data,
      qt_meta_data_widget3d,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_widget3d.stringdata))
        return static_cast<void*>(const_cast< widget3d*>(this));
