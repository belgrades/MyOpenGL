...
public:
    ...
    void setupUi(QWidget *Window)
    {
        ...
        QObject::connect(toolButton_8, SIGNAL(clicked()), myGLWidget, SLOT(refresh_button_pressed()));
        QObject::connect(toolButton_9, SIGNAL(clicked()), myGLWidget, SLOT(delete_button_pressed_slot()));
